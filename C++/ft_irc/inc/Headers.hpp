...
# define    ERR_NICKNAMEINUSEBOT    ":%s 433 %s %s :Moulinette is a reserved nickname/username\r\n"
...
{
	public:
        SignalException(int signum) : _signum(signum) { sprintf(_msg, "Signal %d", _signum); }
