...
/*   Updated: 2023/04/24 16:43:05 by anfreire         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(AForm &src)
{
	// if (src == NULL)
	// {
	// 	std::cout << WHITE << this->_name << RESET << RED << " couldn't sign " << RESET << WHITE << src.getName() << RESET << RED << " because the form is empty!" << RESET<<  std::endl;
	// 	return;
	// }
	try
	{
